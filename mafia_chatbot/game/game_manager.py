...
import game.strategy as strategy
...
class GameManager :
    ...
    def processDay(self) :
        ...
        for i in range(playerCount) :
            ...
            if player.isAI :
                strategy.evaluateVoteStrategy(self.gameState, players[index])
    ...
    def processEvening(self) :
        ...
        for player in players :
            if player.isAI :
                target = player.currentTargets[0]
            else :
        ...
        for player, vote in voteDict.items() :
            if maxVote == vote :
                isTie = True
            elif maxVote < vote :
                isTie = False
        ...
        if isTie :
            ...
            self.gameState.players.remove(maxPlayer)
